...
@section('content')
    <div class="container-fluid px-4">
        <h1 class="mt-4">
            Leerling details
            @can('leerlingen.edit')
                <a class="btn btn-warning" href="{{ route('leerlingen.edit', ['id' => $leerling->id]) }}">Bewerk</a>
            @endcan
            @can('leerlingen.delete')
                <a class="btn btn-danger" href="{{ route('leerlingen.destroy', ['id' => $leerling->id]) }}">Verwijder</a>
            @endcan
        </h1>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            ...
                            <input class="form-control" type="text" id="buddie"
                                value="@if ($leerling->buddie != null) {{ $leerling->buddie->user->name }} @else -- @endif"
                                readonly>
                        </div>
                        <div class="col-md-3">
