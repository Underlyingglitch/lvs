...
return [
    ...
    */
    ...
    'gt'                   => [
        'numeric' => 'Dit veld moet groter zijn dan :value.',
        'file'    => 'Dit veld moet groter zijn dan :value kilobytes.',
        'string'  => 'Dit veld moet groter zijn dan :value tekens.',
        'array'   => 'Dit veld moet meer dan :value items bevatten.',
    ],
    'gte'                  => [
        'numeric' => 'Dit veld moet groter of gelijk zijn aan :value.',
        'file'    => 'Dit veld moet groter of gelijk zijn aan :value kilobytes.',
        'string'  => 'Dit veld moet groter of gelijk zijn aan :value tekens.',
        'array'   => 'Dit veld moet :value of meer items bevatten.',
    ],
    ...
    'lt'                   => [
        'numeric' => 'Dit veld moet kleiner zijn dan :value.',
        'file'    => 'Dit veld moet kleiner zijn dan :value kilobytes.',
        'string'  => 'Dit veld moet kleiner zijn dan :value tekens.',
        'array'   => 'Dit veld moet minder dan :value items bevatten.',
    ],
    'lte'                  => [
        'numeric' => 'Dit veld moet kleiner of gelijk zijn aan :value.',
        'file'    => 'Dit veld moet kleiner of gelijk zijn aan :value kilobytes.',
        'string'  => 'Dit veld moet kleiner of gelijk zijn aan :value tekens.',
        'array'   => 'Dit veld mag maximaal :value items bevatten.',
    ],
    ...
    'prohibited'           => 'Dit veld is niet toegestaan.',
    'prohibited_if'        => 'Dit veld is niet toegestaan wanneer :other :value is.',
    'prohibited_unless'    => 'Dit veld is niet toegestaan tenzij :other voorkomt in :values.',
    'prohibits'            => 'Dit veld staat niet toe dat :other aanwezig is.',
